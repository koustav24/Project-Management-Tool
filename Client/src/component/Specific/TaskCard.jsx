import { Close, CloudUpload, CloudUploadOutlined, Folder } from "@mui/icons-material";
import { Avatar, Box, Button, Card, CardContent, Checkbox, Chip, Divider, FormControlLabel, Grid, IconButton, LinearProgress, Paper, Skeleton, Stack, TextField, Typography } from "@mui/material";
...
const TaskCard = () => {
  ...
  console.log("cmthgds",data)
    ...
    const response = await axios.put(
      ...
      { status: newChecked ? "In Review" : "In Progress" },
...
const handleDelete=async(taskId,id)=>{
  ...
  console.log(id)
  try {
    const res=await axios.post('http://localhost:3000/task/file/delete',{ taskId, public_id:id },{
      withCredentials:true
      ,headers: {
        ...
        <Grid container justifyContent="space-between" alignItems="center">
          ...
          <Grid item>
            <Typography variant="h6" fontWeight="bold">
              Task
              <Chip label={TaskQuery.tusky.status} color="error" variant="outlined" sx={{mx:1}}></Chip>
            </Typography>
          </Grid>
...
export default WebLayout()(TaskCard);
